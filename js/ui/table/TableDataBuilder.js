...
export class TableDataBuilder {
    ...
    buildData(groups, tolerance) {
        ...
        sortedGroups.forEach((group, idx) => {
            ...
            const resolveToSeq = (val) => {
                ...
                // Else try to look up as RefNo
                return getRowIdx(cleanVal) || cleanVal;
            };
            ...
            // Attributes & Weights
            const attrs = this.resolveAttributes(group, firstRow, finalLineNo, dn, len1, type, smartMapping, smartOptions, tolerance);
    ...
    resolveAttributes(group, firstRow, lineNo, dn, len, type, smartMapping, smartOptions, tolerance) {
