...
export const DEFAULT_CONFIG = {
  ...
  pcfRules: {
    PIPE: {
      ...
      skeyStyle: "SKEY", defaultSKEY: null, centrePointTokens: 3,
    ...
    BEND: {
      ...
      skeyStyle: "SKEY", defaultSKEY: "BEBW", centrePointTokens: 3,
    ...
    TEE: {
      ...
      coordinateKeyword: "END-POINT", requiresSKEY: true,
      skeyStyle: "SKEY", defaultSKEY: "TEBW", centrePointTokens: 3,
      angleFormat: "degrees", caSlots: ["CA1", "CA2", "CA3", "CA4", "CA5", "CA6", "CA7", "CA9", "CA10"], extraFields: [],
    },
    FLANGE: {
      keyword: "FLANGE", points: { EP1: "1", EP2: "2" },
      coordinateKeyword: "END-POINT", requiresSKEY: true,
      skeyStyle: "SKEY", defaultSKEY: "FLWN", centrePointTokens: 3,
      angleFormat: "degrees", caSlots: ["CA1", "CA2", "CA3", "CA4", "CA5", "CA6", "CA7", "CA8", "CA9", "CA10"], extraFields: [],
    },
    VALVE: {
      keyword: "VALVE", points: { EP1: "1", EP2: "2" },
      coordinateKeyword: "END-POINT", requiresSKEY: true,
      skeyStyle: "SKEY", defaultSKEY: "VBFL", centrePointTokens: 3,
    ...
    OLET: {
      ...
      skeyStyle: "SKEY", defaultSKEY: "CEBW", centrePointTokens: 3,
      angleFormat: "degrees", caSlots: ["CA1", "CA2", "CA3", "CA4", "CA5", "CA6", "CA7", "CA9", "CA10"], extraFields: [],
    ...
    "REDUCER-CONCENTRIC": {
      ...
      coordinateKeyword: "END-POINT", requiresSKEY: true,
      skeyStyle: "SKEY", defaultSKEY: "RCBW", centrePointTokens: 3,
      angleFormat: "degrees", caSlots: ["CA1", "CA2", "CA3", "CA4", "CA5", "CA6", "CA7", "CA8", "CA9", "CA10"], extraFields: [],
    },
    "REDUCER-ECCENTRIC": {
      keyword: "REDUCER-ECCENTRIC", points: { EP1: "1", EP2: "2" },
      coordinateKeyword: "END-POINT", requiresSKEY: true,
      skeyStyle: "SKEY", defaultSKEY: "REBW", flatDirection: "DOWN", centrePointTokens: 3,
    ...
    "MISC-COMPONENT": {
      ...
      coordinateKeyword: "END-POINT", requiresSKEY: true,
      skeyStyle: "SKEY", defaultSKEY: "COMP", centrePointTokens: 3,
      angleFormat: "degrees", caSlots: ["CA1", "CA2", "CA3", "CA4", "CA5", "CA6", "CA7", "CA8", "CA9", "CA10"], extraFields: [],
    },
  },
